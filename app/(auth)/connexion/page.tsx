...
export default function ConnexionPage() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "radial-gradient(circle at 12% 15%, rgba(89,195,190,0.15), rgba(89,195,190,0) 32%), radial-gradient(circle at 88% 78%, rgba(0,128,96,0.24), rgba(0,128,96,0) 34%), #0f141b",
      }}
    >
      <div className="w-full max-w-sm rounded-3xl overflow-hidden border animate-fade-in-up" style={{ borderColor: "rgba(255,255,255,0.14)", background: "rgba(16, 22, 31, 0.82)", boxShadow: "var(--shadow-lg)" }}>
        <div className="px-6 pt-6 pb-5 border-b" style={{ borderColor: "rgba(255,255,255,0.1)" }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <div className="text-xs" style={{ color: "#9da9b8" }}>Espace utilisateur</div>
            </div>
          </div>
          <h1 className="text-2xl font-semibold text-white">Connexion</h1>
          <p className="text-sm mt-1" style={{ color: "#aab4c3" }}>
            Retrouvez vos favoris et vos alertes prix.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div className="text-center text-sm" style={{ color: "#aab4c3" }}>
            ...
            <Link href="/inscription" className="font-semibold" style={{ color: "#d7f7ee" }}>
              S'inscrire
            </Link>
          </div>

          <div className="text-center">
            <Link href="/" className="text-sm" style={{ color: "#8f9cae" }}>
